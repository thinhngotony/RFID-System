...
CREATE TABLE `drfid_log_move`  (
  ...
  INDEX `idx_drfid_log_move_dlm_rfid_cd_dlm_cnt`(`dlm_rfid_cd`, `dlm_cnt`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 494009 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1833 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 420 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mst_antena`  (
  `shelf_no` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `antena_no` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `antena_index` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `m_min` int(11) NULL DEFAULT NULL,
  `m_max` int(11) NULL DEFAULT NULL,
