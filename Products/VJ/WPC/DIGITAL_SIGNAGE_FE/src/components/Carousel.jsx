...
class Carousels extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      cCodeInfo: this.props.cCodeInfo
    };
  }
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    return { screen: props.screen, title: props.title, data: props.data, videoUrl: props.videoUrl, dataWaitingContent: props.dataWaitingContent, noMessage: props.noMessage, cCodeInfo: props.cCodeInfo };
  }
